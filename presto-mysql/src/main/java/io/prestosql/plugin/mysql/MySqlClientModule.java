...
import io.prestosql.plugin.jdbc.DecimalPropertiesProvider;
        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        newSetBinder(binder, SessionPropertiesProvider.class).addBinding().to(DecimalPropertiesProvider.class).in(Scopes.SINGLETON);
    }
