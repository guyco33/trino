...
public class TestSapHanaClient
{
    private static final JdbcClient CLIENT = new SapHanaClient(
            new BaseJdbcConfig(),
            new SapHanaConfig(),
            session -> {
            ...
            throws SQLException
    {
        ...
        PreparedStatement statementProxy = newProxy(PreparedStatement.class, (proxy, method, args) -> {
            // Calling setNull with a proper JDBC type is important for SapHana as it
