...
public class TestSapHanaConfig
{
    @Test
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(SapHanaConfig.class)
                .setMaxReconnects(3)
                .setConnectionTimeout(new Duration(60, TimeUnit.SECONDS))
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = ImmutableMap.<String, String>builder()
                .put("sap_hana.max-reconnects", "4")
                .put("sap_hana.connection-timeout", "4s")
                .put("sap_hana.synonyms.enabled", "true")
                .buildOrThrow();
