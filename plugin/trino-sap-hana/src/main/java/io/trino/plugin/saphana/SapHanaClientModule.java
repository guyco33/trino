        ...
        extends AbstractConfigurationAwareModule
{
    ...
    @Singleton
    @ForBaseJdbc
    public static ConnectionFactory createConnectionFactory(BaseJdbcConfig config, CredentialProvider credentialProvider, SapHanaConfig sapHanaConfig)
            throws SQLException
    {
        return new DriverConnectionFactory(
                new Driver(),
                config.getConnectionUrl(),
                getConnectionProperties(sapHanaConfig),
                credentialProvider);
    }
