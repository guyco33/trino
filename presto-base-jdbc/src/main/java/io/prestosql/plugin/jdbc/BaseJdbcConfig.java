...
public class BaseJdbcConfig
{
    ...
    public boolean isIncludedTypeNameMappedToVarchar(String typeName)
    {
        return getTypesMappedToVarcharInclude() != null && this.includeTypeNamesMappingToVarchar.contains(typeName);
    }

    public boolean isExcludedTypeNameMappedToVarchar(String typeName)
    {
        return getTypesMappedToVarcharExclude() != null && this.excludeTypeNamesMappingToVarchar.contains(typeName);
    }
